...
void readParameters(std::string config_file)
{
    ...
    {
        Cfgparam.gt1_or_est0 = fsSettings["gt1_or_est0"];
    ...
    Cfgparam.num_frames_fuse = fsSettings["num_frames_fuse"];
    ...
    Cfgparam.origin_x = fsSettings["origin_x"];
    Cfgparam.origin_y = fsSettings["origin_y"];
    Cfgparam.origin_z = fsSettings["origin_z"];
    ...
    Cfgparam.VoxelSize = fsSettings["VoxelSize"];
    Cfgparam.Truncation = fsSettings["Truncation"];
